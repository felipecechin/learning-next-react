...
export default function MenuLateral(props) {
    return (
        <aside className="flex flex-col bg-gray-200 text-gray-700 dark:bg-gray-900">
            ...
            <ul>
                <MenuItem onClick={() => console.log('logout')} texto="Sar" icone={IconeSair} className={"text-red-600 dark:text-red-400 hover:bg-red-400 hover:text-white dark:hover:text-white"} />
            </ul>
        </aside>
    )
}